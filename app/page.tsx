          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg text-slate-600">
                OmnixAI answers questions instantly, qualifies prospects, and
                books calls around the clock — so your website actually converts.
              </p>
                ...
                <div className="rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700 p-6 text-white">
                  ...
                  <div className="mt-4 space-y-3 text-sm">
                    <div className="max-w-[85%] rounded-2xl bg-white/10 px-4 py-3">
                      Hi 👋 What are you looking to improve on your website
                      today?
                    </div>
                    ...
                    <div className="max-w-[85%] rounded-2xl bg-white/10 px-4 py-3">
                      Perfect. I can capture and qualify visitors 24/7 and book
                      calls automatically. Want to see a quick demo?
                    </div>
                  </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <p className="text-sm text-slate-700">
                “We started getting enquiries within the first week of adding
                OmnixAI.”
              </p>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <p className="text-sm text-slate-700">
                “The assistant handles our FAQs and captures leads 24/7. Huge
                time saver.”
              </p>
              <div className="mt-3 text-xs font-semibold text-slate-500">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <p className="text-sm text-slate-700">
                “Feels like having a sales assistant on the site without hiring
                anyone.”
              </p>
              <div className="mt-3 text-xs font-semibold text-slate-500">
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-base leading-7 text-slate-600">
              OmnixAI answers questions instantly, qualifies prospects, and
              pushes the best leads to book calls.
            </p>
          </div>
      ...
      <section id="pricing" className="bg-slate-50 py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-base leading-7 text-slate-600">
              Choose the setup that fits your business — both include ongoing
              monthly maintenance.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-600">
                AI chatbox trained on your business to answer questions and
                capture leads.
              </p>
            ...
            <div className="relative rounded-2xl border border-orange-200 bg-white p-8 shadow-lg">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Advanced assistant designed to qualify leads and push bookings
                more aggressively.
              </p>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
              <div className="text-sm font-semibold text-slate-900">
                Website + AI (Done-For-You)
              </div>

              <p className="mt-2 text-sm text-slate-600">
                High-converting website with OmnixAI built in to turn visitors
                into qualified leads and bookings.
              </p>
          ...
          <p className="mt-8 text-center text-xs text-slate-500">
            Prices shown exclude VAT (if applicable). Cancel monthly maintenance
            anytime.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                a: "Ongoing updates, monitoring, improvements based on real chats, and support.",
              },
              {
                q: "How is OmnixAI trained?",
                a: "On your website pages, FAQs, and any documents you provide, tuned to your brand voice.",
              },
              {
                q: "How long does setup take?",
                a: "Standard assistants go live within days. Premium setups and website builds may take longer depending on scope.",
              },
              {
                q: "Can it capture leads and bookings?",
                a: "Yes. It captures details and routes qualified prospects to booking links.",
              },
              {
                q: "Do you build the website as well as the AI assistant?",
                a: "Yes. We can build your website from scratch and embed OmnixAI, or integrate OmnixAI into your existing site.",
              },
              {
                q: "What’s included in the website build?",
                a: "Starter builds include a 1–3 page custom website, mobile responsive design, basic SEO setup, contact forms, and OmnixAI fully installed.",
              },
            ].map((item) => (
              <div
                key={item.q}
