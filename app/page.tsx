      ...
      <section id="features" className="py-20">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              { title: "Works 24/7", desc: "Never miss a lead — respond instantly, even after hours.", items: ["Instant answers", "Lead qualification", "Always-on availability"] },
              { title: "Trained on your business", desc: "Uses your pages, FAQs, and tone of voice.", items: ["Website ingestion", "Custom tone", "Continuous updates"] },
              { title: "Turns chats into bookings", desc: "Captures details and routes prospects to your calendar.", items: ["Lead capture", "Booking links", "CRM-ready exports"] },
            ].map((f) => (
